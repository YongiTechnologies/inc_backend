...
// =============================================================================
// PUBLIC TRACKING — registered FIRST, no auth middleware
// IMPORTANT: These must come before any authenticated routes to prevent
// Express from incorrectly applying auth. Also avoids conflict with the
// router.use(authenticate) in tracking.routes.js.
// =============================================================================
